...
/**
 * iOS Stripe implementation using shared REST API client.
 *
 * Headless operations (tokens, payment methods, intents) use the REST API via Ktor.
 * UI components (PaymentSheet, Apple Pay) require native implementation using
 * the StripePaymentSheet CocoaPod.
 */
