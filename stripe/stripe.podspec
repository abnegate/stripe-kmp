Pod::Spec.new do |spec|
    spec.name                     = 'stripe'
    spec.version                  = '1.0.0'
    spec.homepage                 = 'https://github.com/jakebarnby/stripe-kmp'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Kotlin Multiplatform wrapper for Stripe SDK'
    ...
    if !Dir.exist?('build/cocoapods/framework/StripeKMP.framework') || Dir.empty?('build/cocoapods/framework/StripeKMP.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :stripe:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':stripe',
        'PRODUCT_MODULE_NAME' => 'StripeKMP',
    }
    spec.script_phases = [
        {
            :name => 'Build stripe',
